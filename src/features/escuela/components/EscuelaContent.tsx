  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      {estadisticas.map((stat, index) => (
        ...
        >
          <div className="w-16 h-16 bg-[#E6A817]/10 rounded-full flex items-center justify-center mx-auto mb-4 text-[#E6A817]">
            {stat.icono && iconMap[stat.icono]}
          </div>
          <p className="text-3xl font-bold text-[#001F3F] mb-1">{stat.valor}</p>
...
function Valores() {
  const valoresIconos = [
    ...
    { valor: 'Innovación e investigación', icono: Lightbulb, color: 'bg-amber-500' },
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      {valoresIconos.map((item, index) => {
        ...
        return (
          ...
          >
            <div className={`w-14 h-14 ${item.color} rounded-full flex items-center justify-center mx-auto mb-4 text-white group-hover:scale-110 transition-transform`}>
          ...
          {reglamentos.map((doc) => (
            ...
            >
              <div className="flex-1 min-w-0">
                <p className="font-medium text-sm text-gray-900 group-hover:text-[#001F3F] truncate">
                  {doc.nombre}
                </p>
              </div>
              <Download className="h-4 w-4 text-gray-400 group-hover:text-[#E6A817] flex-shrink-0 ml-2" />
            </a>
          ))}
        </CardContent>
      </Card>
    ...
    <div className="space-y-16">
      ...
      <section id="historia">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <Badge className="bg-[#E6A817]/10 text-[#E6A817] mb-4">Nuestra Historia</Badge>
          ...
          {/* Stats Card */}
          <Card className="bg-gradient-to-br from-[#001F3F] to-[#003366] text-white border-0">
            <CardContent className="pt-8">
              <div className="grid grid-cols-2 gap-8">
                <div className="text-center">
                  <p className="text-5xl font-bold text-[#E6A817] mb-2">35+</p>
                  <p className="text-gray-300">Años de trayectoria</p>
                </div>
                <div className="text-center">
                  <p className="text-5xl font-bold text-[#E6A817] mb-2">2,500+</p>
                  <p className="text-gray-300">Egresados</p>
                </div>
                <div className="text-center">
                  <p className="text-5xl font-bold text-[#E6A817] mb-2">15+</p>
                  <p className="text-gray-300">Maestrías</p>
                </div>
                <div className="text-center">
                  <p className="text-5xl font-bold text-[#E6A817] mb-2">5</p>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-300">
                  Universidad licenciada por la Superintendencia Nacional de Educación Superior Universitaria
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <section id="mision-vision">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#001F3F]">Misión y Visión</h2>
        </div>
        
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="border-l-4 border-l-[#E6A817] hover:shadow-lg transition-shadow">
            <CardHeader>
              <div className="w-14 h-14 bg-[#E6A817]/10 rounded-full flex items-center justify-center mb-4">
                <Target className="h-7 w-7 text-[#E6A817]" />
              </div>
          ...
          <Card className="border-l-4 border-l-[#001F3F] hover:shadow-lg transition-shadow">
            <CardHeader>
              <div className="w-14 h-14 bg-[#001F3F]/10 rounded-full flex items-center justify-center mb-4">
                <Eye className="h-7 w-7 text-[#001F3F]" />
              </div>
      ...
      <section id="valores" className="bg-gray-50 -mx-4 px-4 py-12 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 rounded-2xl">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#001F3F] mb-4">Nuestros Valores</h2>
      ...
      <section id="estadisticas">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#001F3F] mb-4">EPG en Números</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section id="autoridades">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#001F3F] mb-4">Autoridades</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section id="documentos">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#001F3F] mb-4">Documentos Institucionales</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
