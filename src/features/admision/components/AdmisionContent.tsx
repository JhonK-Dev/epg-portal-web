    ...
    <div className="relative">
      ...
      <div className="hidden md:block">
        <div className="flex items-center justify-between relative">
          ...
          <div className="absolute top-5 left-0 h-1 bg-[#D4A017] z-0" style={{ width: '20%' }} />
      ...
      {programasConVacantes.map(({ slug, vacantes }) => {
        ...
        return (
          <a 
            key={slug}
            href={`/programas/${slug}`}
            className="group bg-white rounded-lg border p-4 hover:shadow-lg hover:border-[#D4A017] transition-all"
          >
            <Badge className={tipoProgramaBadgeColors[programa.tipo]}>
              {programa.tipo === 'maestria' ? 'Maestría' : 'Doctorado'}
            </Badge>
            <h3 className="font-semibold text-gray-900 mt-2 group-hover:text-[#0A1628] line-clamp-2">
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <ArrowRight className="h-4 w-4 text-[#D4A017] group-hover:translate-x-1 transition-transform" />
            </div>
          </a>
        );
      })}
    ...
    <div className="space-y-16">
      ...
      <section id="cronograma">
        <div className="text-center mb-8">
          <Badge className="bg-[#D4A017]/10 text-[#D4A017] mb-4">Cronograma</Badge>
          <h2 className="text-3xl font-bold text-[#0A1628] mb-4">Fechas Importantes</h2>
      ...
      <section id="proceso">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#0A1628] mb-4">Proceso de Admisión</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section id="programas">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#0A1628] mb-4">Programas con Vacantes</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section id="requisitos">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#0A1628] mb-4">Requisitos de Admisión</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section id="costos">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#0A1628] mb-4">Costos y Formas de Pago</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section id="faq">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-[#0A1628] mb-4">Preguntas Frecuentes</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section id="inscribete">
        <Card className="bg-gradient-to-r from-[#0A1628] to-[#0D2240] text-white p-8 md:p-12">
          <div className="text-center max-w-2xl mx-auto">
            <Badge className="bg-[#D4A017] text-[#0A1628] mb-4">¡Inscríbete ahora!</Badge>
