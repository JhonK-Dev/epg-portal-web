...
export const StatsSection: React.FC = () => {
  return (
    <section className="py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-[#0A1628] relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-10 left-10 w-64 h-64 bg-[#D4A017]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#D4A017]/5 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-[#D4A017]/20 flex items-center justify-center group-hover:bg-[#D4A017]/30 transition-colors">
                  <Icon className="w-6 h-6 text-[#D4A017]" />
                </div>
                <div className="text-3xl lg:text-4xl font-bold text-white mb-1">
                  {stat.value}
                </div>
                <div className="text-[#D4A017] font-medium text-sm mb-1">
                  {stat.label}
                </div>
