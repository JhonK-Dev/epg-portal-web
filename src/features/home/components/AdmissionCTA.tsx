...
export const AdmissionCTA: React.FC = () => {
  ...
  return (
    <section className="section-py px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-white to-slate-50 relative overflow-hidden">
      {/* Decorative elements - subtle accents */}
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-slate-100/50 rounded-full -translate-x-1/2 translate-y-1/2 blur-2xl" />
        <div className="absolute top-0 right-0 w-96 h-96 bg-slate-100/50 rounded-full translate-x-1/2 -translate-y-1/2 blur-3xl" />
      </div>
