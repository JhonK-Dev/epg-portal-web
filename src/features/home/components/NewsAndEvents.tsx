        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {publications.map((pub, index) => {
              ...
              if (index === 0) {
                ...
                return (
                  <a
                    ...
                    className="group block bg-gradient-to-br from-[#0A1628] to-[#0D2240] rounded-2xl overflow-hidden hover:shadow-xl transition-all"
                  >
                    <div className="p-8">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="inline-flex items-center gap-1 text-[#D4A017] font-medium group-hover:gap-2 transition-all">
                          Leer más
              ...
              return (
                ...
                >
                  <div className="w-24 h-24 bg-gradient-to-br from-[#0A1628] to-[#0D2240] rounded-lg flex-shrink-0 flex items-center justify-center">
                    <Calendar className="w-8 h-8 text-[#D4A017]/50" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className={`inline-block ${typeConfig.bgColor} ${typeConfig.textColor} text-xs font-bold px-2 py-0.5 rounded mb-2`}>
                      {typeConfig.label}
                    </span>
                    <h4 className="font-bold text-[#0A1628] group-hover:text-[#D4A017] transition-colors line-clamp-2 mb-1">
                      {pub.titulo}
                    </h4>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 rounded-2xl p-6">
              <h3 className="font-bold text-[#0A1628] text-lg mb-6 flex items-center gap-2">
              ...
              <div className="space-y-4">
                {events.map((event) => {
                  ...
                  return (
                    ...
                    >
                      {/* Date Badge */}
                      <div className="w-14 h-14 bg-[#0A1628] rounded-lg flex flex-col items-center justify-center flex-shrink-0">
                        <span className="text-white font-bold text-lg leading-none">{eventDate.day}</span>
                        <span className="text-[#D4A017] text-xs font-medium">{eventDate.month}</span>
                      </div>

                      {/* Event Info */}
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-[#0A1628] text-sm line-clamp-2 mb-1">
                          {event.titulo}
                        </h4>
              ...
              <a
                ...
                className="block text-center text-[#D4A017] font-medium text-sm mt-6 hover:underline"
              >
