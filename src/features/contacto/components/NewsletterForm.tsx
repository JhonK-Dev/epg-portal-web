...
export function NewsletterForm({ variant = 'default', className = '' }: NewsletterFormProps) {
      ...
      <form onSubmit={handleSubmit} className={`flex gap-2 ${className}`}>
        <div className="relative flex-1">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2 rounded-lg border text-sm focus:ring-2 focus:ring-epg-gold outline-none disabled:opacity-50 ${
  ...
  if (variant === 'card') {
    return (
      <div className={`bg-gradient-to-r from-epg-navy to-epg-navy-light text-white rounded-xl p-8 ${className}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  <input
                    ...
                    className={`w-full md:w-64 px-4 py-3 rounded-lg text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-epg-gold outline-none disabled:opacity-50 ${
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Tu correo electrónico"
            disabled={status === 'loading' || status === 'success'}
            className={`w-full pl-12 pr-4 py-3 rounded-lg border text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-epg-gold outline-none disabled:opacity-50 ${
