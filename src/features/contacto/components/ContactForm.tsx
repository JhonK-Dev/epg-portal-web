...
export function ContactForm() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-2xl text-[#0A1628]">Envíanos un mensaje</CardTitle>
        <CardDescription>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3 rounded-lg border focus:ring-2 focus:ring-[#D4A017] focus:border-transparent outline-none disabled:opacity-50 ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                onChange={handleChange}
                disabled={status === 'loading'}
                className={`w-full pl-12 pr-4 py-3 rounded-lg border focus:ring-2 focus:ring-[#D4A017] focus:border-transparent outline-none disabled:opacity-50 appearance-none bg-white ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                rows={5}
                className={`w-full pl-12 pr-4 py-3 rounded-lg border focus:ring-2 focus:ring-[#D4A017] focus:border-transparent outline-none disabled:opacity-50 resize-none ${
          ...
          <Button
            type="submit"
            disabled={status === 'loading'}
            className="w-full bg-[#0A1628] hover:bg-[#0D2240] text-white font-semibold py-3 h-auto"
          >
            {status === 'loading' ? (
              <>
          ...
          <p className="text-xs text-gray-500 text-center">
            ...
            <a href="/politica-privacidad" className="text-[#D4A017] hover:underline">
