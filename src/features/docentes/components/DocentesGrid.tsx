    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full lg:w-80 pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#D4A017] focus:border-transparent outline-none"
          />
          {busqueda && (
            <button
              onClick={() => setBusqueda('')}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {docentesFiltrados.map((docente) => {
            ...
            return (
              ...
              >
                {/* Avatar */}
                <div className="h-48 bg-gradient-to-br from-[#0A1628] to-[#0D2240] flex items-center justify-center relative overflow-hidden">
                  {docente.foto ? (
                    <img 
                      src={docente.foto} 
                ...
                <CardContent className="p-5">
                  <h3 className="font-bold text-[#0A1628] mb-1 group-hover:text-[#D4A017] transition-colors">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {docente.email && (
                      <a 
                        ...
                        className="inline-flex items-center gap-1 text-xs text-gray-500 hover:text-[#0A1628] transition-colors"
                      >
      ...
      <section className="bg-gray-50 -mx-4 px-4 py-12 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 rounded-2xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div className="w-14 h-14 bg-[#0A1628] rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:bg-[#D4A017] transition-colors">
              <BookOpen className="h-7 w-7 text-white" />
            </div>
            <h3 className="font-bold text-[#0A1628] mb-2">Material Académico</h3>
          ...
          >
            ...
            <h3 className="font-bold text-[#0A1628] mb-2">Aula Virtual</h3>
            <p className="text-gray-600 text-sm">
          ...
          >
            ...
            <h3 className="font-bold text-[#0A1628] mb-2">Calendario Académico</h3>
            <p className="text-gray-600 text-sm">
