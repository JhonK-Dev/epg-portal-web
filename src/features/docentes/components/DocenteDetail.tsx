...
export function DocenteDetail({ docente }: DocenteDetailProps) {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#0A1628] to-[#0D2240] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="text-sm mb-6">
            <ol className="flex items-center gap-2">
              ...
              <li className="text-gray-400">/</li>
              <li className="text-[#D4A017]">{docente.apellidos}</li>
            </ol>
          </nav>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-shrink-0">
              <div className="w-40 h-40 lg:w-48 lg:h-48 rounded-2xl bg-white/10 flex items-center justify-center text-white text-5xl lg:text-6xl font-bold border-4 border-[#D4A017]/30">
            ...
            <div className="flex-1">
              ...
              <p className="text-xl text-[#D4A017] mb-4">{docente.especialidad}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      {docente.areasInvestigacion.map((area, index) => (
                        <Badge key={index} variant="secondary" className="bg-[#D4A017]/10 text-[#0A1628]">
                          {area}
                        </Badge>
                      ))}
                    </div>
                    ...
                    <div className="space-y-4">
                      {docente.formacionAcademica.map((formacion, index) => (
                        <div key={index} className="flex gap-4 items-start">
                          ...
                          <div>
                            <h4 className="font-semibold text-[#0A1628]">{formacion.grado}</h4>
                    ...
                    <div className="space-y-4">
                      {docente.experienciaProfesional.map((exp, index) => (
                        <div key={index} className="flex gap-4 items-start">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-[#0A1628]">{exp.cargo}</h4>
                    ...
                    <div className="space-y-4">
                      {docente.publicacionesAcademicas.map((pub, index) => (
                        <div key={index} className="p-4 bg-gray-50 rounded-lg">
                          <h4 className="font-medium text-[#0A1628] mb-1">{pub.titulo}</h4>
                    ...
                    <ul className="space-y-2">
                      {docente.proyectosInvestigacion.map((proyecto, index) => (
                        <li key={index} className="flex items-start gap-2">
                          <div className="w-2 h-2 bg-[#D4A017] rounded-full mt-2 flex-shrink-0" />
            ...
            <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      {programasDocente.map((programa) => (
                        ...
                        >
                          ...
                          <h4 className="text-sm font-medium text-[#0A1628] group-hover:text-[#D4A017] transition-colors">
                            {programa!.nombre}
                          </h4>
                        </a>
                      ))}
              ...
              {/* CTA - Contactar */}
              <Card className="bg-[#0A1628] text-white border-0">
                <CardContent className="pt-6">
                  ...
                  <Button
                    className="w-full bg-[#D4A017] text-[#0A1628] hover:bg-[#B8860B]"
                    asChild
                  >
